...
# # Generate 100 random entries for the DataFrame
# num_entries = 100
...
#     notification_event_df = pd.DataFrame({
#         "TruckID": [random.randint(1, 10)],
#         "LoadID": [random.randint(1000, 9999)],
#         "TimestampOfNotification": [random_date(start_date, end_date)],
#         "EquipType": [random.choice(["TypeA", "TypeB", "TypeC"])],
#         "EstimatedProfit": [round(random.uniform(1000, 5000), 2)],
#         "Mileage": [random.randint(5000, 20000)],
#     })
